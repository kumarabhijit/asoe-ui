...
INSERT INTO zasoe_exception_link (exception_id, ui_order_id, vbeln, edi_msg_id, email_msg_id, intent, lifecycle_state, scenario, _replicated_at) VALUES
  ...
  ('exc-017', 'PO-PHR-001', '0000090001', 'EDI-2026-0008', NULL, 'PRICE_HOLD_RELEASE', 'RESOLVED', 'PO 101.00 vs PR00 100.00 (within 2% tolerance) — hold released, no LIFSK.', '2026-04-06T08:13:00Z'),
  ('exc-018', 'PO-PHR-002', '0000090002', 'EDI-2026-0009', NULL, 'PRICE_HOLD_RELEASE', 'PENDING_REVIEW', 'PO 105.00 vs PR00 100.00 (escalate band) — LIFSK=ZP.', '2026-04-28T08:18:00Z'),
  ...
  ('exc-021', 'PO-PM-ROUTING-001', '0000090003', 'EDI-2026-0012', NULL, 'CONTRACTUAL_CORRECTION', 'RESOLVED', 'EDI line price 95.00 vs PR00 100.00 — routed to contractual correction; resolved.', '2026-04-27T10:13:00Z'),
  ('exc-022', 'SO-CB-001', '0000090004', NULL, NULL, 'MASS_PRICING_ERROR', 'FAILED', 'Mass pricing recalc circuit-breaker halt; VBAK 0000090004 untouched.', '2026-04-29T07:12:01Z'),
  ('exc-023', 'SO-NR-001', '0000090005', NULL, NULL, 'MASS_PRICING_ERROR', 'FAILED', 'Mass pricing recalc no-recipe halt; VBAK 0000090005 untouched.', '2026-04-23T07:42:00Z'),
  ('exc-024', 'SO-GW-001', '0000090006', 'EDI-2026-0013', NULL, 'DUPLICATE_PO', 'FAILED', 'Duplicate-PO recipe gate failure; VBAK 0000090006 untouched.', '2026-04-20T08:12:02Z'),
  ('exc-025', 'PO-PHR-BAD', '0000090007', 'EDI-2026-0014', NULL, 'PRICE_HOLD_RELEASE', 'FAILED', 'Price-hold recipe crash; LIFSK=ZP still set on VBAK 0000090007.', '2026-04-16T08:42:00Z'),
  ...
  ('exc-040', 'EML-CHG-2026-0051', '0000090012', NULL, 'MSG-2026-0002', 'MANUAL_ORDER_INTAKE', 'PENDING_REVIEW', 'zemail_intake change request against VBAK 0000090012.', '2026-05-18T09:15:10Z'),
  ('exc-041', 'EML-CHG-2026-0052', '0000090013', NULL, 'MSG-2026-0003', 'MANUAL_ORDER_INTAKE', 'PENDING_REVIEW', 'zemail_intake expedite request against VBAK 0000090013.', '2026-05-18T11:33:05Z'),
  ('exc-042', 'EML-CHG-2026-0053', '0000090014', NULL, 'MSG-2026-0004', 'MANUAL_ORDER_INTAKE', 'ESCALATED', 'zemail_intake cancellation request against VBAK 0000090014 (escalated).', '2026-05-19T08:28:40Z'),
  ('exc-043', 'EML-CHG-2026-0054', '0000090015', NULL, 'MSG-2026-0005', 'MANUAL_ORDER_INTAKE', 'PENDING_REVIEW', 'zemail_intake substitution request against VBAK 0000090015.', '2026-05-19T13:53:12Z'),
  ...
  ('exc-046', 'EDI-PO-2026-7781', '0000090016', NULL, 'MSG-2026-0008', 'MANUAL_ORDER_INTAKE', 'RESOLVED', 'zemail_intake COMPLETED — VBAK 0000090016 auto-created from email PO.', '2026-05-22T07:22:18Z'),
  ...
  ('exc-027', 'PO-WMT-Q1-RESET-001', '0000090008', 'EDI-2026-0015', NULL, 'PRICE_HOLD_RELEASE', 'PENDING_REVIEW', 'PO 21.10 vs PR00 20.00 on the Q1 reset order; LIFSK=ZP.', '2026-05-04T07:23:30Z'),
  ('exc-028', 'PO-WMT-Q1-RESET-001', '0000090008', NULL, NULL, 'BACK_ORDER', 'RESOLVED', 'Same order: VBEP 1280/1600 split; MARD Atlanta/Memphis/Dallas stock.', '2026-05-04T07:26:30Z'),
  ('exc-029', 'PO-WMT-Q1-RESET-001-R2', '0000090009', 'EDI-2026-0016', NULL, 'DUPLICATE_PO', 'BLOCKED', 'Retransmit order auto-rejected (ABGRU=52); duplicate zedi_850_in row.', '2026-05-05T01:43:30Z'),
  ('exc-030', 'PO-COST-EOQ-2026Q1', '0000090010', NULL, NULL, 'OVER_MAX', 'PENDING_REVIEW', 'Both EOQ lines over KNMT zzmax_qty 1500; LIFSK=Z2.', '2026-05-06T11:14:00Z'),
  ('exc-031', 'PO-COST-EOQ-2026Q1', '0000090010', NULL, NULL, 'PALLET_CONFIG', 'RESOLVED', 'Same order: MARM PAL 300/layer 60 — pallet plan auto-aligned.', '2026-05-06T11:17:00Z'),
  ('exc-032', 'PO-KR-WK15-2026', '0000090011', NULL, NULL, 'MIN_ORDER_QTY', 'PENDING_REVIEW', 'Lines below MVKE AUMNG (72/50) on the wk-15 order; LIFSK=Z3.', '2026-05-07T06:54:00Z'),
  ('exc-033', 'PO-KR-WK15-2026', '0000090011', NULL, NULL, 'DELIVERY_DELAY', 'RESOLVED', 'Same order: LIKP 0080090011 re-routed TR-FEDEX-D, zzeta within 1 day.', '2026-05-07T06:59:30Z');
