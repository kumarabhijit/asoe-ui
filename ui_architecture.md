...
- **Responsive collapse (current):** CSS grid `xl:grid-cols-[320px_280px_minmax(0,1fr)]` ≥1280px (full three-pane), `lg:grid-cols-[360px_minmax(0,1fr)]` 1024-1279px (queue + detail; the middle column collapses and the picker re-emerges inline in the right pane), single column below 1024px.
